...
impl<T: GridCell + Default + PartialEq> Grid<T> {
        ...
        D: PartialEq,
    {
        ...
        // Width reflow mutates historical rows and therefore thaws them. Put
        // the read-mostly portion back into its compact representation before
        // returning to the interactive path.
        self.compact_retained_rows();
