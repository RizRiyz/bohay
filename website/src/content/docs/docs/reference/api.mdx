...
| agents | `agent.list` · `agent.get` · `agent.name` · `agent.send` · `agent.keys` · `agent.read` · `agent.sessions` · `agent.resume` · `pane.report_session` · `pane.report_event` |
...
Event names: `pane.created` · `pane.closed` · `pane.moved` · `pane.agent_status_changed` ·
