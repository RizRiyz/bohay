...
description: Scroll any pane's history with the wheel, trackpad, or keyboard scroll mode, and copy text with a drag.
---

## Scrolling

**Mouse/trackpad:** just scroll over a pane. Full-screen apps (vim, TUI agents
that take the whole pane) keep their own scrolling, so bohay forwards the wheel
