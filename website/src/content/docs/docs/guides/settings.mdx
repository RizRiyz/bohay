...
| **Theme** | 15 built-in palettes (dark and light), including all four Catppuccin flavours (Mocha, Macchiato, Frappe, Latte) and Gruvbox dark and light, previewed live as you move |
...
The colours come straight from bohay's own registry, so what you see here is
what the app ships.
