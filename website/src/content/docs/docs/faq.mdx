...
**Settings → Layout → Scrollback memory**. Bohay's current terminal engine translates
...
scrolling, and bohay forwards the wheel to them, so use the app's native scrolling
there.
